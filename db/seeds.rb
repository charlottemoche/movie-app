Actor.create([
  {first_name: "Cher", last_name: "Sarkisian", known_for: "Moonstruck", age: 74, gender: "Female"},
  {first_name: "Meryl", last_name: "Streep", known_for: "Kramer vs. Kramer", age: 71, gender: "Female"},
  {first_name: "Viola", last_name: "Davis", known_for: "Fences", age: 55, gender: "Female"},
  {first_name: "Christian", last_name: "Bale", known_for: "American Psycho", age: 46, gender: "Male"},
  {first_name: "Richard", last_name: "Gere", known_for: "Primal Fear", age: 71, gender: "Male"}
])
